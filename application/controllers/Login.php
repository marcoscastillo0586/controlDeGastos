...
class Login extends CI_Controller {
	...
	public function validarAcceso(){
		...
		{
			if($this->c->dar_login($_POST['usuario'],md5($_POST['password']))){
				$_SESSION['primer_ingreso']  = ($_POST['password'] != '12345678') ? 0 : 1;
						  header("location:".base_url()."index.php/Dashboard/index"); 	 	
					}else{//usuario o pass incorrecto
						$mensaje['mensaje'] = 1;
						$this->load->view('login/body',$mensaje);
					}
		}
		else{	$this->logout(); }
	}
